...
class VerifyPassWordHandle(tornado.web.RequestHandler):
    ...
    def get_data(self):
        ...
        if request_argument == "":
            ...
            if tuple_request[0]:
                ...
                pass_word = request_json["pass_word"]
                qr_code_data = self.query_user_data(user_account)
                pw = qr_code_data["pass_word"]
                if pass_word == pw:
                    try:
